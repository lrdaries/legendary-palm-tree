(() => {
  ...
  const ui = (() => {
    const els = {
      ...
      // Category buttons
      catBag: qs('#cat-bag'),
      catAccessories: qs('#cat-accessories'),
      catDresses: qs('#cat-dresses'),
      catSuits: qs('#cat-suits'),
    };
      ...
      els.productQuickViewContent.innerHTML = `
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            ${description ? `<div class="text-gray-600 mb-6 leading-relaxed">${description}</div>` : ''}
            ...
            <div class="space-y-4">
              ...
              <p class="text-xs text-gray-500 text-center">
                ...
                Secure transaction • Fast delivery • Customer support
              </p>
            </div>
          </div>
        </div>
  ...
  const wireUp = () => {
    ...
    ui.els.catBag?.addEventListener('click', () => {
      window.location.href = 'collections.html?category=Bag';
    });

    ui.els.catAccessories?.addEventListener('click', () => {
      window.location.href = 'collections.html?category=accessories';
    });

    ui.els.catDresses?.addEventListener('click', () => {
      window.location.href = 'collections.html?category=dresses';
    });

    ui.els.catSuits?.addEventListener('click', () => {
      window.location.href = 'collections.html?category=suits';
    });
